...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#f0f4f9] dark:bg-slate-950 text-slate-700 dark:text-slate-300 py-12 border-t border-slate-200/80 dark:border-slate-800 transition-colors duration-300">
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-bold mb-4 text-slate-900 dark:text-white text-base">{t('footer.quickLinks')}</h4>
            <ul className="space-y-2 text-sm text-slate-600 dark:text-slate-400 font-medium">
              <li><a href="#about" className="hover:text-primary dark:hover:text-emerald-400 transition-colors">{t('footer.about')}</a></li>
              <li><a href="#services" className="hover:text-primary dark:hover:text-emerald-400 transition-colors">{t('footer.services')}</a></li>
              <li><Link to="/research-innovation" className="hover:text-primary dark:hover:text-emerald-400 transition-colors">{t('nav.researchInnovation')}</Link></li>
              <li><a href="#ai-assessment" className="hover:text-primary dark:hover:text-emerald-400 transition-colors">{t('footer.aiAssessment')}</a></li>
              <li><a href="#practitioner" className="hover:text-primary dark:hover:text-emerald-400 transition-colors">{t('footer.practitioner')}</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-2.5 flex-wrap">
              <a
                ...
                aria-label="Facebook"
                className="flex h-10 w-10 items-center justify-center rounded-full bg-white dark:bg-slate-900 text-slate-700 dark:text-slate-200 border border-slate-200/80 dark:border-slate-800 hover:-translate-y-1 hover:bg-primary hover:text-white transition-all shadow-sm"
              >
        ...
        <div className="text-center text-sm text-slate-500 dark:text-slate-400 font-medium">
          ...
          <p className="mt-1 text-xs text-slate-400 dark:text-slate-500">Future Smart Health - Combining Tradition with Innovation</p>
        </div>
      </div>
    </footer>
  )

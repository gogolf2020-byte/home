export default {
  ...
  ai: {
    ...
    feature1Title: 'Proactive Intervention: From Screening to Action',
    feature1Desc: 'Moving beyond the traditional "screen without treating" model, smart wearables and IoT devices capture abnormal signals in real time—shifting care from passive monitoring to proactive intervention.',
    feature2Title: 'Continuous Management: Your Digital Health Twin',
    feature2Desc: 'Build a lifelong personal health model that dynamically tracks indicator trends, accurately predicts future disease risks, and enables early prevention and intervention for chronic and serious conditions.',
    feature3Title: 'Personalised Care: Your Private AI Health Manager',
    feature3Desc: 'Data-driven plans provide personalised guidance on diet, exercise and sleep around the clock, making professional health support part of everyday life.',
    feature4Title: 'Ultimate Vision: Reshaping the Health Ecosystem',
    feature4Desc: 'Shift healthcare from "treating illness" to "preventing illness," stop serious diseases before they arise, and make better health accessible to everyone.',
    callToActionLabel: 'CALL TO ACTION',
    callToActionText: 'Empowering Traditional Chinese Medicine through technology and bringing the principle of "prevention before treatment" to life. We are not only product innovators—we are advocates for healthier living, committed to making Traditional Chinese Medicine accessible to every family.',
    step1Title: '01 — Scan',
  ...
  contact: {
    ...
    locationsTitle: 'Clinic Locations',

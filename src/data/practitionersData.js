...
export const practitionersData = [
  {
    ...
    shortTitle: {
      zh: 'ACC 注册针灸师 · 推拿及道家手法治疗师',
      en: 'ACC Registered Acupuncturist · Tui Na & Taoist Manual Therapy Practitioner',
      de: 'ACC Registrierter Akupunkteur · Tui Na & Daoistische Manuelle Therapie',
      ko: 'ACC 등록 한의사 · 추나 및 도가 수기치료 전문가'
    },
    title: {
      zh: 'ACC 注册针灸师 ｜ 推拿及道家手法治疗师 ｜ 常氏武术第九代传承人',
      en: 'ACC Registered Acupuncturist | Tui Na & Taoist Manual Therapy Practitioner | 9th-Gen Chang Martial Arts Inheritor',
      de: 'ACC Registrierter Akupunkteur | Tui Na & Daoistische Manuelle Therapie | Erbe der Chang-Kampfkunst (9. Gen.)',
      ko: 'ACC 등록 한의사 ｜ 추나 및 도가 수기치료 전문가 ｜ 상씨무술 제9대 전수자'
    },
    mentor: {
      zh: 'Pain Relief Without Needles · 不用针的独特手法疼痛调护与功能康复',
      en: 'Pain Relief Without Needles · A distinctive hands-on approach to pain and movement',
    ...
    hometown: {
      ...
      de: 'ACC Registrierter Akupunkteur · Erbe der Chang-Kampfkunst',
      ko: 'ACC 등록 한의사 · 상씨무술 제9대 전수자'
    },
    tags: {
      zh: ['ACC 注册针灸师', '非针刺手法治疗', '推拿及道家手法', '30年武术与气机整合', '常氏武术第九代传人'],
      en: ['ACC Registered Acupuncturist', 'Needle-Free Manual Therapy', 'Taoist Manual Therapy', 'Tui Na Bodywork', '30+ Yrs Martial Arts'],
      de: ['ACC-Registrierter Akupunkteur', 'Nadelfreie Manuelle Therapie', 'Daoistische Manuelle Therapie', 'Tui Na', '30+ Jahre Kampfkunst'],
      ko: ['ACC 등록 한의사', '비침습 수기치료', '추나 및 도가수기', '30년 무술·기혈 통합', '상씨무술 9대 전수자']
    },
    shortDesc: {
      zh: 'ACC 注册针灸师，融合30余年传统武术太极与道家手法，专注不用针的手法疼痛治疗与肌骨功能康复。',
      en: 'ACC Registered Acupuncturist bringing 30+ years of martial arts and Taoist manual therapy for needle-free pain relief and functional recovery.',
      de: 'ACC-registrierter Akupunkteur mit über 30 Jahren Kampfkunst- und Tai-Chi-Erfahrung, spezialisiert auf nadelfreie manuelle Schmerztherapie.',
      ko: 'ACC 등록 한의사로 30년 이상의 전통 무술·태극권과 도가 수기요법을 결합하여 침 없는 맞춤형 수기 통증 치료 및 기능 회복을 전문으로 합니다.'
    },
    bioParagraphs: {
      zh: [
        '靳晓东（Xiaodong JIN）为 ACC 注册针灸师、推拿及道家手法治疗师，为 Wellness Spring 带来一套极具特色的临床治疗方法。他接受过健康科学（针灸专业）系统训练，同时拥有超过 30 年中国传统武术、太极及常氏武术实践经验，为常氏武术体系第九代传承人。长期的武术训练，使他对人体结构、运动、力量传导、气机和身心平衡形成了非常深厚而独特的理解。',
        '他最突出的临床特色之一是：“不用针，也可以做疼痛治疗”。通过特定的手法、身体结构调整、推拿及道家传统手法，他会根据患者身体的紧张点、活动受限和结构失衡进行精准处理。在实际临床中，不少患者最惊讶的地方是没有扎针，仅通过手法治疗，就能感觉疼痛和活动度出现明显改善。',
        '靳医师在常规针灸以外，为患者提供更具特色的非针刺、手法型疼痛治疗选择。他已积累大量疼痛治疗案例，尤其擅长处理颈肩疼痛、腰背疼痛、髋/膝及四肢疼痛、肌肉及软组织紧张、活动受限以及慢性与反复性疼痛。他的治疗体系涵盖推拿（Tui Na）、道家手法治疗（Taoist Manual Therapy）、道家三十六锁（Taoist 36 Locks Manual Therapy）、脐周针法（Peri-Umbilical Acupuncture）以及武术与身体结构力线整合。'
      ],
      en: [
        'Xiaodong JIN brings to Wellness Spring a highly distinctive combination of acupuncture, traditional Chinese manual therapy, and more than 30 years of Chinese martial arts practice. Trained in Health Science (Acupuncture), Xiaodong has practised Tai Chi and Chang Martial Arts for over three decades and is recognised within his tradition as a ninth-generation inheritor of Chang Martial Art. His clinical approach draws on this deep understanding of movement, body structure, Qi balance, and traditional hands-on therapeutic methods.',
        'What makes Xiaodong particularly distinctive is his manual, non-needling approach to pain management. Using specialised hands-on techniques, including Taoist manual therapy and traditional body-balancing methods, he works with the body’s structure, movement patterns, and areas of tension to support the relief of musculoskeletal discomfort and restore freer movement. Many patients are especially surprised by how much change can sometimes be felt without the use of acupuncture needles, reporting noticeable improvements during or soon after treatment.',
        'In clinical practice, Xiaodong has accumulated extensive experience working with people experiencing neck, shoulder, back, hip, knee, and other musculoskeletal pain, soft tissue tension, and chronic or recurrent conditions. His work also incorporates Tui Na, Taoist 36 Locks manual therapy, peri-umbilical acupuncture, bio-energetic approaches, and structural biomechanics, allowing treatment to be tailored to the individual rather than relying on one single technique. His philosophy: "Sometimes the body does not need more force — it needs the right adjustment, in the right place, at the right time."'
      ],
      de: [
        'Xiaodong JIN bereichert Wellness Spring mit einer außergewöhnlichen Kombination aus Akupunktur, traditioneller chinesischer Manualtherapie und über 30 Jahren Praxis in chinesischen Kampfkünsten. Ausgebildet in Gesundheitswissenschaften (Akupunktur), praktiziert Xiaodong seit über drei Jahrzehnten Tai Chi sowie Chang-Kampfkunst und ist anerkannter Linienhalter der 9. Generation der Chang-Kampfkunst. Seine klinische Arbeit stützt sich auf dieses tiefe Verständnis von Bewegungsmustern, Körperstatik, Qi-Balance und traditionellen manuellen Behandlungsmethoden.',
        'Besonders auszeichnend für Xiaodong ist sein manueller, nadelfreier Behandlungsansatz zur Schmerztherapie. Mit spezialisierten manuellen Techniken wie daoistischer Manualtherapie und traditioneller Körperausrichtung behandelt er Spannungszonen, Bewegungseinschränkungen und strukturelle Dysbalancen des Bewegungsapparats. Viele Patientinnen und Patienten sind überrascht, wie spürbar Schmerzlinderung und gesteigerte Beweglichkeit ganz ohne Nadeln bereits während oder kurz nach der Sitzung eintreten.',
        'Xiaodong verfügt über umfassende klinische Erfahrung bei Schmerzen in Nacken, Schultern, Rücken, Hüften, Knien sowie bei chronischen und wiederkehrenden Muskel- und Gelenkbeschwerden. Neben klassischer Akupunktur integriert er Tui Na, daoistische 36-Schlösser-Manualtherapie, periumbilikale Akupunktur und bioenergetische Ansätze für maßgeschneiderte Behandlungen.'
      ],
      ko: [
        '진효동(Xiaodong JIN) 한의사는 ACC 등록 한의사이자 추나 및 도가 수기치료 전문가로서 Wellness Spring에 독창적인 임상 치료법을 제공합니다. 건강과학(침구학)을 전공하였으며, 30년 이상 중국 전통 무술, 태극권 및 상씨무술을 수련하여 상씨무술 제9대 전수자로 공인받았습니다. 오랜 무술 수련을 바탕으로 인체 구조, 운동 역학, 힘의 전달, 기혈 순환 및 균형에 대한 깊이 있는 통찰을 임상에 적용하고 있습니다.',
        '진 한의사의 가장 돋보이는 임상적 특징은 "침을 사용하지 않고도 탁월한 통증 치료가 가능하다"는 점입니다. 특화된 도가 수기치료, 인체 구조 교정, 추나 요법을 통해 환자의 근육 긴장 부위, 가동 범위 제한, 체형 불균형을 정밀하게 치료합니다. 실제 임상에서 많은 환자들이 침을 맞지 않고 수기치료만으로도 통증이 현저히 줄고 관절 움직임이 즉각 개선되는 경험에 깊은 만족을 표하고 있습니다.',
        '진 한의사는 일반적인 침 치료 외에도 침에 두려움이 있거나 수기치료를 선호하는 분들을 위해 비침습적 수기 통증 치료를 제공합니다. 목·어깨, 허리·골반, 무릎·사지 관절 통증, 연부조직 긴장 및 만성·재발성 통증 치료에 풍부한 임상 경험을 보유하고 있으며, 추나(Tui Na), 도가 36쇄 수기술(Taoist 36 Locks), 제주침법(Peri-Umbilical Acupuncture), 생체 역학 조정을 결합하여 1:1 맞춤형 진료를 시행합니다.'
      ]
    },
    educationList: {
      zh: [
        { period: '执业认证', degree: '新西兰 ACC 注册认证针灸师', school: 'ACC Registered Acupuncturist (NZ)' },
        { period: '专业学历', degree: '健康科学（针灸专业）学士', school: 'Bachelor of Health Science (Acupuncture)' },
        { period: '武术传承', degree: '常氏武术第九代传承人 · 30余年传统武术与太极研习', school: 'Chang Martial Arts Tradition' },
        { period: '特色研修', degree: '推拿 ｜ 道家手法治疗 ｜ 道家三十六锁 ｜ 脐周针法', school: 'Taoist Manual Therapy & Bodywork' }
      ],
      en: [
        { period: 'Accreditation', degree: 'NZ ACC Registered Acupuncturist', school: 'ACC Registered Acupuncturist (NZ)' },
        { period: 'Academic', degree: 'Bachelor of Health Science (Acupuncture)', school: 'Health Science (Acupuncture)' },
        { period: 'Lineage', degree: '9th-Generation Inheritor of Chang Martial Art · 30+ Yrs Tai Chi', school: 'Chang Martial Arts Tradition' },
        { period: 'Specialist Training', degree: 'Tui Na · Taoist Manual Therapy · Taoist 36 Locks · Peri-Umbilical Acupuncture', school: 'Traditional Taoist Bodywork & Bio-Energetics' }
      ],
      de: [
        { period: 'Zulassung', degree: 'NZ ACC Registrierter Akupunkteur', school: 'ACC Registered Acupuncturist (NZ)' },
        { period: 'Akademisch', degree: 'Bachelor of Health Science (Akupunktur)', school: 'Gesundheitswissenschaften (Akupunktur)' },
        { period: 'Tradition', degree: 'Erbe der Chang-Kampfkunst 9. Generation · 30+ Jahre Tai Chi', school: 'Chang-Kampfkunst-Tradition' },
        { period: 'Spezialisierung', degree: 'Tui Na · Daoistische Manualtherapie · 36-Schlösser-Technik · Periumbilikale Akupunktur', school: 'Traditionelle Daoistische Körperarbeit' }
      ],
      ko: [
        { period: '전문 자격', degree: '뉴질랜드 ACC 등록 면허 한의사', school: 'ACC Registered Acupuncturist (NZ)' },
        { period: '학사 학위', degree: '건강과학(침구학) 학사 BHSc (Acupuncture)', school: 'Health Science (Acupuncture)' },
        { period: '무술 전수', degree: '상씨무술 제9대 전수자 · 30년 이상 전통 무술 및 태극권 수련', school: 'Chang Martial Arts Tradition' },
        { period: '전문 연수', degree: '추나 요법 ｜ 도가 수기치료 ｜ 도가 36쇄 수기술 ｜ 제주침법', school: 'Taoist Manual Therapy & Bodywork' }
      ]
    },
    researchPoints: {
      zh: [
        '融汇30余年太极与常氏武术精髓，将人体运动生物力学、结构力线与气机流转贯通于临床诊疗。',
        '独创“非针刺”特色手法疼痛管理：以道家传统手法与结构调衡为核心，实现温和、无针、高效止痛。',
        '精通推拿（Tui Na）、道家三十六锁手法与脐周针法，全面调理急慢性软组织损伤及关节活动受限。',
        '治疗理念：真正有效的治疗，有时并不是“用力更多”，而是找到正确的位置、正确的方向和正确的时机。'
      ],
      en: [
        'Drawing on 30+ years of Tai Chi and Chang Martial Arts to integrate movement, body structure, and Qi balance.',
        'Specialises in non-needling manual therapy for clients seeking gentle, effective needle-free pain relief.',
        'Incorporates Tui Na, Taoist 36 Locks manual therapy, and peri-umbilical acupuncture for personalised recovery.',
        'Clinical philosophy: "Sometimes the body does not need more force — it needs the right adjustment, in the right place, at the right time."'
      ],
      de: [
        'Integration von über 30 Jahren Tai-Chi- und Kampfkunsterfahrung in Biomechanik und Qi-Fluss.',
        'Spezialisierung auf nadelfreie manuelle Schmerztherapie für eine schonende, effektive Behandlung.',
        'Kombination aus Tui Na, daoistischer 36-Schlösser-Therapie und periumbilikaler Akupunktur.',
        'Behandlungsphilosophie: „Manchmal braucht der Körper nicht mehr Kraft – sondern die richtige Justierung, an der richtigen Stelle, zum richtigen Zeitpunkt.“'
      ],
      ko: [
        '30년 이상의 태극권 및 전통 무술 경험을 인체 생체역학과 기혈 순환 임상 판단에 완벽히 융합.',
        '도가 전통 수기요법과 체형 교정을 결합하여 침 없는 비침습적 통증 완화 치료 체계 확립.',
        '추나(Tui Na), 도가 36쇄 수기술, 제주침법을 활용한 급만성 근골격계 통증 및 관절 가동성 개선.',
        '진료 철학: 진정한 치료는 무리한 힘을 가하는 것이 아니라, 정확한 부위와 방향, 최적의 타이밍에 올바른 조율을 하는 것입니다.'
      ]
    },
    specialtiesTitle: {
      zh: 'Specialties 临床专长与特色领域',
      en: 'Areas of Focus & Clinical Specialties',
      de: 'Schwerpunkte & Behandlungsmethoden',
      ko: 'Specialties 전문 진료 분야'
    },
    specialties: {
      zh: [
        'Pain Relief Without Needles 非针刺手法疼痛调理（颈肩、腰背、髋膝及四肢痛症）',
        'Musculoskeletal Care 肌骨及软组织紧张、慢性与反复性疼痛综合调护',
        'Non-Needling Manual Therapy 适合偏好无针治疗者的特定手法与结构调衡',
        'Tui Na & Taoist Manual Therapy 中医推拿、道家手法治疗与道家三十六锁特色手法',
        'Peri-Umbilical Acupuncture & Qi Integration 脐周针法与传统武术气机/力线整合调理'
      ],
      en: [
        'Pain Relief Without Needles: Neck, shoulder, back, hip, knee and general musculoskeletal discomfort',
        'Non-Needling Manual Therapy: Specialised hands-on treatment for clients who prefer a needle-free approach',
        'Tui Na & Traditional Manual Therapy: Traditional Chinese bodywork focusing on movement, tension and functional balance',
        'Taoist 36 Locks Manual Therapy: Specialised hands-on balancing techniques within his clinical system',
        'Peri-Umbilical Acupuncture & Movement/Qi Integration: Drawing on 30+ years of Tai Chi and martial arts experience'
      ],
      de: [
        'Nadelfreie Schmerztherapie: Nacken-, Schulter-, Rücken-, Hüft-, Knie- und Bewegungsschmerzen',
        'Manuelle Therapie ohne Nadeln: Spezialisierte manuelle Behandlung für Patienten, die nadel-freie Verfahren bevorzugen',
        'Tui Na & Traditionelle Manualtherapie: Traditionelle chinesische Körperarbeit für Beweglichkeit und Ausgleich',
        'Daoistische 36-Schlösser-Manualtherapie: Spezifische Regulierungstechniken im Rahmen ganzheitlicher Behandlung',
        'Periumbilikale Akupunktur & Kampfkunst/Qi-Integration: Basiert auf über 30 Jahren Tai-Chi- und Kampfkunstpraxis'
      ],
      ko: [
        'Pain Relief Without Needles: 비침습 수기 통증 치료 (목, 어깨, 허리, 골반, 무릎 및 사지 통증)',
        'Musculoskeletal Care: 근골격계 연부조직 긴장, 가동 범위 제한 및 만성 재발성 통증 케어',
        'Non-Needling Manual Therapy: 침 치료에 부담을 느끼는 분들을 위한 특화 도가 수기술',
        'Tui Na & Taoist Manual Therapy: 추나 요법, 도가 수기치료 및 도가 36쇄 수기술',
        'Peri-Umbilical Acupuncture & Qi Integration: 제주침법 및 전통 무술 기혈 조절'
      ]
    },
  ...
  },
  {
    ...
    title: {
      ...
      ko: '의학박사 ｜ 민족의학 (몽골 전통침구 및 오료요법 전문)'
    },
    mentor: {
    ...
    tags: {
      ...
      ko: ['베이징중의약대 박사', '기황석학 문하생', '몽골 전통침술', '우울증 신경기전 연구']
    },
    shortDesc: {
      ...
      ko: '베이징중의약대학교 박사 출신으로 몽골 전통침술, 화침, 사혈요법 및 우울증 신경기전 연구를 수행하였으며 척추 질환 및 난치성 통증을 전문으로 합니다.'
    },
    bioParagraphs: {
      zh: [
      ...
      ko: [
        '치엔다먼(Damen QIAN) 박사는 베이징중의약대학교 민족의학(몽골의학 오료요법) 박사 학위를 취득하였으며, 국가 기황석학이자 국가급 무형문화유산 전수자인 우란(乌兰) 교수를 사사했습니다. 내몽골의과대학교에서 몽골의학 학사 및 석사(몽골 정골의학)를 마쳤으며, 내몽골국제몽골병원에서 임상 수련을 수료했습니다.',
        '박사 과정 중 "몽골의학 진뇌술(震脑术)의 우울증 개선 메커니즘"에 대해 CUMS 동물 모델을 구축하여 심층 연구를 수행하였으며, 5-HT 매개 cAMP-PKA-CREB-BDNF 신호 전달 경로 및 PIEZO 기계적 자극 수용체 메커니즘을 규명하였습니다.',
        '임상에서는 몽골 전통 침술, 화침, 온침, 사혈요법과 변증 몽골 약물치료를 결합하여 뇌졸중 후유증, 목디스크, 허리디스크, 오십견, 급만성 요통 및 불면, 우울, 불안, 소화기 질환에 대한 맞춤형 치료를 제공합니다.'
      ]
    },
    educationList: {
      zh: [
      ...
      ko: [
        { period: '2023.09—2026.06', degree: '의학박사 · 민족의학 전공 (몽골의학 오료요법)', school: '베이징중의약대학교 (BUCM)' },
        { period: '2019.09—2022.07', degree: '의학석사 · 민족의학 전공 (몽골 정골의학)', school: '내몽골의과대학교' },
        { period: '2019.09—2022.07', degree: '의사 표준화 임상 수련', school: '내몽골국제몽골병원' },
        { period: '2014.09—2019.07', degree: '의학학사 · 몽골의학과', school: '내몽골의과대학교' }
      ]
    },
    researchPoints: {
      zh: [
      ...
      ko: [
        '몽골의학 진뇌술의 우울증 개선 메커니즘 연구 및 만성 스트레스(CUMS) 모델 정립.',
        '5-HT 매개 cAMP-PKA-CREB-BDNF 신호 전달 경로를 규명하여 뇌 신경전달물질 조절 기전 분석.',
        '전통 몽골 물리자극 치료에서 PIEZO 기계적 자극 수용체의 분자생물학적 반응 탐색.',
        '국가급 민족의학 연구 프로젝트 참여 및 전통 고문헌 정리·학술지 논문 게재.'
      ]
    },
    specialtiesTitle: {
      zh: 'Specialties 临床专长',
    ...
    specialties: {
      ...
      ko: [
        '몽골 전통 침구 요법 (일반침, 화침, 온침, 사혈요법 등)',
        '뇌졸중 후유증 관리 및 중추·말초 신경 손상 재활',
        '경추증(목디스크), 요추간판탈출증(허리디스크), 오십견 등 척추·관절 질환',
        '급만성 요추 염좌 및 각종 난치성 통증 조절',
        '체질 맞춤형 약물 조절 (불면, 우울, 불안, 소화기 장애 및 아건강 상태)'
      ]
    },
  ...
  },
  {
    ...
    shortTitle: {
      ...
      ko: 'Wellness Spring 설립자 · ACC & CMCNZ 등록 한의사 · AI-한의학 임상 융합 전문가'
    },
    title: {
      ...
      ko: 'Wellness Spring 설립자 ｜ ACC & CMCNZ 등록 한의사 ｜ AI-한의학 임상 융합 및 다문화 의료 소통 전문가'
    },
    mentor: {
    ...
    tags: {
      ...
      ko: ['Wellness Spring 설립자', 'ACC & CMCNZ 등록', 'AI-한의학 임상 융합', '전문 의료·법률 통역', '뉴질랜드 건강과학 학사']
    },
    shortDesc: {
      ...
      ko: 'Wellness Spring 설립자로서 한의학 임상 진료, AI 건강 분석, 전문 의료·법률 통역 및 공공 서비스 경험을 결합하여 한의사 주도의 신뢰할 수 있는 통합 헬스케어 플랫폼을 구축하고 있습니다.'
    },
    bioParagraphs: {
      zh: [
      ...
      ko: [
        'Helene Yu(여리) 원장은 융합 헬스케어 전문가이자 뉴질랜드 Wellness Spring의 설립자입니다. 전통 한의학 임상 진료, 전문 의료 및 법률 통역, 공공 서비스, 국제 기업 경영에 걸친 폭넓은 경력을 보유하고 있습니다. 현재 AI 건강 분석과 한의사 주도의 4진(望·聞·問·切) 진단, 구조화된 실세계 데이터 및 다문화 건강 관리의 임상 융합에 주력하고 있습니다.',
        'ACC 및 CMCNZ 등록 한의사이자 MATRIX AI 제품 트레이너로서, AI 분석과 전통 한의학 진단을 연계한 체계적인 임상 워크플로우를 개발하고 있습니다. 대형 언어 모델(LLM)을 활용해 임상 데이터를 구조화하고 비교하면서도, 최종 의료적 판단과 처방은 반드시 면허 한의사의 주도 하에 철저히 검증되도록 보장합니다.',
        '뉴질랜드 건강과학(침구학) 학사를 취득하고 오클랜드공과대학교(AUT)에서 의료·법률 통역 및 건강관리 대학원 과정을 수료했습니다. 영어, 북경어, 광동어에 능통하며 "언어, 문화, 기술을 통해 전통 한의학과 글로벌 건강을 연결한다"는 사명을 실천하고 있습니다.'
      ]
    },
    educationList: {
      zh: [
      ...
      ko: [
        { period: '학사 학위', degree: '건강과학(침구학) 학사 BHSc (Acupuncture)', school: '뉴질랜드 (BHSc)' },
        { period: '대학원 수료', degree: '의료 및 법률 고급 통역 대학원 과정', school: '오클랜드공과대학교 (AUT)' },
        { period: '대학원 수료', degree: '건강관리 및 스포츠 코칭학 연구', school: '오클랜드공과대학교 (AUT)' },
        { period: '이중 면허', degree: '뉴질랜드 ACC 등록 한의사 & CMCNZ 등록의', school: 'ACC & CMCNZ New Zealand' }
      ]
    },
    researchPoints: {
      zh: [
      ...
      ko: [
        '체계적인 AI-한의학 임상 워크플로우 구축: 문진 → MATRIX AI 분석 → 4진 진찰 → 한의사 검토 → 맞춤 케어 → 추적 관리.',
        '뉴질랜드 다민족 환경에서 AI 보조 한의학 분석의 다문화 임상 검증 및 모델 공정성 연구.',
        '2개 국어 인코딩 4진 설문지 및 모델 독립적(Model-agnostic) 임상 LLM 프롬프트 아키텍처 개발.',
        '법원, 병원 및 정부 기관에서의 수십 년간 영어, 북경어, 광동어 고급 전문 의료 통역 경험.'
      ]
    },
    specialtiesTitle: {
      zh: 'Specialties 临床专长',
    ...
    specialties: {
      ...
      ko: [
        'AI-한의학 임상 융합 및 진료 워크플로우 설계',
        '근거 기반 한의학, 침구 치료 및 4진(望·聞·問·切) 진료',
        '다문화 의료 커뮤니케이션 및 전문 통역 (영어, 북경어, 광동어)',
        '다문화 건강 데이터 및 임상 유효성 검증',
        'ACC 손상 재활 치료 및 심신 전인적 케어'
      ]
    },
